...
import cn.spider.framework.transaction.sdk.datasource.sql.struct.TableMetaCacheFactory;
import cn.spider.framework.transaction.sdk.util.CollectionUtils;
import cn.spider.framework.transaction.sdk.util.Constants;
import cn.spider.framework.transaction.sdk.core.compressor.CompressorFactory;
import cn.spider.framework.transaction.sdk.core.compressor.CompressorType;
import cn.spider.framework.transaction.sdk.core.constants.ClientTableColumnsName;
import cn.spider.framework.transaction.sdk.core.exception.BranchTransactionException;
...
public abstract class AbstractUndoLogManager implements UndoLogManager {
    ...
    protected static final String UNDO_LOG_TABLE_NAME = "undo_log";
    ...
    protected static final boolean ROLLBACK_INFO_COMPRESS_ENABLE = true;

    protected static final CompressorType ROLLBACK_INFO_COMPRESS_TYPE = CompressorType.ZIP;

    protected static final long ROLLBACK_INFO_COMPRESS_THRESHOLD = 64l;
    ...
    public void undo(DataSourceProxy dataSourceProxy, String xid, long branchId,Connection conn) throws TransactionException {
        ...
        for (; ; ) {
            try {
                ...
                throw new BranchTransactionException(TransactionExceptionCode.BranchRollbackFailed_Retriable, String
    ...
    public BranchUndoLog selectBranchUndoLog(String xid, long branchId, Connection conn) throws SQLException {
        PreparedStatement selectPST = conn.prepareStatement(SELECT_UNDO_LOG_SQL);
        selectPST.setLong(1, branchId);
        selectPST.setString(2, xid);
